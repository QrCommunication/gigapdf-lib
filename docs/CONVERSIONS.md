...
> foundation** for the per-format binary record parsers to follow; on its own it
> does not yet change the text-only output of the legacy formats above.
