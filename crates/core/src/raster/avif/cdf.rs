//! AUTO-GENERATED from dav1d `src/cdf.c` (BSD-2-Clause, (c) VideoLAN /
//! Two Orioles). Default AV1 CDF tables, inverse Q15 (`32768 - cdf`) with a
//! trailing adaptation counter + SIMD padding per dav1d's layout. DO NOT EDIT
//! by hand; regenerate via tools/extract_av1_cdf (compile-and-dump).
#![allow(dead_code)]
#![allow(clippy::all)]

// qcat selector: q = (q>20) + (q>60) + (q>120). Index the *_Q tables by it.

pub(crate) static PARTITION: [[[u16; 16]; 4]; 5] = [
    [
        [
...
pub(crate) static KF_Y_MODE: [[[u16; 16]; 5]; 5] = [
    [
        [
            17180, 15741, 13430, 12550, 12086, 11658, 10943, 9524, 8579, 4603, 3675, 2302, 0, 0, 0,
            0,
        ],
        [
            20752, 14702, 13252, 12465, 12049, 11324, 10880, 9736, 8334, 4110, 2596, 1359, 0, 0, 0,
            0,
        ],
        [
        ...
        [
            18677, 17362, 16326, 13960, 13632, 13222, 12770, 10672, 8022, 3183, 1810, 306, 0, 0, 0,
            0,
        ],
        [
            20646, 19503, 17165, 16267, 14159, 12735, 10377, 7185, 6331, 2507, 1695, 293, 0, 0, 0,
            0,
        ],
    ],
    [
        [
            22745, 13183, 11920, 11328, 10936, 10008, 9679, 8745, 7387, 3754, 2286, 1332, 0, 0, 0,
            0,
        ],
        [
        ...
        [
            25324, 19987, 12591, 12040, 11691, 11161, 10598, 9363, 8299, 4853, 3678, 2276, 0, 0, 0,
            0,
        ],
        [
            24231, 18079, 17336, 15681, 15360, 14596, 14360, 12943, 8119, 3615, 1672, 558, 0, 0, 0,
            0,
        ],
        [
            25225, 18537, 17272, 16573, 14863, 12051, 10784, 8252, 6767, 3093, 1787, 774, 0, 0, 0,
            0,
        ],
    ],
    [
        ...
        [
            22050, 21034, 17814, 15544, 15203, 14844, 14207, 11245, 8890, 3793, 2481, 516, 0, 0, 0,
            0,
        ],
        [
            23574, 22910, 16267, 15505, 14344, 13597, 11205, 6807, 6207, 2696, 2031, 305, 0, 0, 0,
            0,
        ],
    ],
    [
        [
            20166, 18369, 17280, 14387, 13990, 13453, 13044, 11349, 7708, 3072, 1851, 359, 0, 0, 0,
            0,
        ],
        [
            24565, 18947, 18244, 15663, 15329, 14637, 14364, 13300, 7543, 3283, 1610, 426, 0, 0, 0,
            0,
        ],
        [
            24317, 23037, 17764, 15125, 14756, 14343, 13698, 11230, 8163, 3650, 2690, 750, 0, 0, 0,
            0,
        ],
        [
            25054, 23720, 23252, 16101, 15951, 15774, 15615, 14001, 6025, 2379, 1232, 240, 0, 0, 0,
            0,
        ],
        [
            23925, 22488, 21272, 17451, 16116, 14825, 13660, 10050, 6999, 2815, 1785, 283, 0, 0, 0,
            0,
        ],
    ],
    [
        ...
        [
            23205, 19142, 17688, 16876, 15012, 11905, 10561, 8532, 7388, 3115, 1625, 491, 0, 0, 0,
            0,
        ],
        [
            24412, 23867, 15152, 14512, 13418, 12662, 10170, 6821, 6302, 2868, 2245, 507, 0, 0, 0,
            0,
        ],
        [
            21933, 20953, 19644, 16726, 15750, 14729, 13821, 10015, 8153, 3279, 1885, 286, 0, 0, 0,
            0,
        ],
        [
...
pub(crate) static UV_MODE: [[[u16; 16]; 13]; 2] = [
    [
        [
...
pub(crate) static ANGLE_DELTA: [[u16; 8]; 8] = [
...
pub(crate) static FILTER_INTRA_MODE: [u16; 8] = [23819, 19992, 15557, 3210, 0, 0, 0, 0];
pub(crate) static USE_FILTER_INTRA: [[u16; 2]; 22] = [
    [16384, 0],
    [16384, 0],
    [16384, 0],
    [16384, 0],
...
pub(crate) static TX_SIZE: [[[u16; 4]; 3]; 4] = [
...
pub(crate) static TXTP_INTRA1: [[[u16; 8]; 13]; 2] = [
    [
...
pub(crate) static TXTP_INTRA2: [[[u16; 8]; 13]; 3] = [
    [
...
pub(crate) static CFL_SIGN: [u16; 8] = [31350, 30645, 19428, 14363, 5796, 4425, 474, 0];
pub(crate) static CFL_ALPHA: [[u16; 16]; 6] = [
    [
...
pub(crate) static SKIP: [[u16; 2]; 3] = [[1097, 0], [16253, 0], [28192, 0]];
pub(crate) static DELTA_Q: [u16; 4] = [4608, 648, 91, 0];
pub(crate) static DELTA_LF: [[u16; 4]; 5] = [
    [4608, 648, 91, 0],
    [4608, 648, 91, 0],
    [4608, 648, 91, 0],
    [4608, 648, 91, 0],
...
pub(crate) static INTRABC: [u16; 2] = [2237, 0];
pub(crate) static PAL_Y_MODE: [[[u16; 2]; 3]; 7] = [
    [[1092, 0], [29349, 0], [31507, 0]],
    [[856, 0], [29909, 0], [31788, 0]],
    [[945, 0], [29368, 0], [31987, 0]],
    [[738, 0], [29207, 0], [31864, 0]],
    [[459, 0], [25431, 0], [31306, 0]],
    [[503, 0], [28753, 0], [31247, 0]],
    [[318, 0], [24822, 0], [32639, 0]],
];
pub(crate) static PAL_UV_MODE: [[u16; 2]; 2] = [[307, 0], [11280, 0]];
pub(crate) static PAL_SZ: [[[u16; 8]; 7]; 2] = [
    [
...
pub(crate) static COLOR_MAP: [[[[u16; 8]; 5]; 7]; 2] = [
    [
        [
            [4058, 0, 0, 0, 0, 0, 0, 0],
            [16384, 0, 0, 0, 0, 0, 0, 0],
...
pub(crate) static COEF_SKIP_Q: [[[[u16; 2]; 13]; 5]; 4] = [
    [
        [
            [919, 0],
            [26876, 0],
...
pub(crate) static DC_SIGN_Q: [[[[u16; 2]; 3]; 2]; 4] = [
    [
...
pub(crate) static EOB_BIN_16_Q: [[[[u16; 8]; 2]; 2]; 4] = [
    [
        [
...
pub(crate) static EOB_BIN_32_Q: [[[[u16; 8]; 2]; 2]; 4] = [
    [
        [
    ...
    [
        [
            [31779, 31519, 30749, 28617, 21983, 0, 0, 0],
            [32455, 32327, 31669, 29851, 24206, 0, 0, 0],
        ],
        [
            [24374, 22416, 18836, 13913, 6754, 0, 0, 0],
            [30190, 28644, 24587, 19098, 8534, 0, 0, 0],
        ],
    ],
    [
        [
            [30253, 29765, 28316, 24606, 16727, 0, 0, 0],
            [32194, 31947, 30932, 27679, 19640, 0, 0, 0],
        ],
        [
            [19300, 16465, 12407, 7663, 3487, 0, 0, 0],
            [29226, 27266, 22353, 16008, 7124, 0, 0, 0],
        ],
    ],
    [
        [
            [28151, 27059, 24322, 19184, 9633, 0, 0, 0],
            [31612, 31066, 29093, 23494, 12229, 0, 0, 0],
        ],
        [
            [10682, 8486, 5758, 2998, 1025, 0, 0, 0],
            [25069, 21871, 11877, 5842, 1140, 0, 0, 0],
        ],
    ],
];
pub(crate) static EOB_BIN_64_Q: [[[[u16; 8]; 2]; 2]; 4] = [
    [
        [
...
pub(crate) static EOB_BIN_128_Q: [[[[u16; 8]; 2]; 2]; 4] = [
    [
        [
    ...
    [
        [
            [31402, 31030, 30241, 27752, 23413, 16971, 8125, 0],
            [32414, 32210, 31824, 30008, 25481, 18731, 10989, 0],
        ],
        [
            [19141, 16522, 12595, 8339, 4820, 2353, 905, 0],
            [26493, 22879, 17999, 9604, 4780, 2275, 496, 0],
        ],
    ],
    [
        [
            [29296, 27883, 25279, 20287, 14251, 8232, 3133, 0],
...
pub(crate) static EOB_BIN_256_Q: [[[[u16; 16]; 2]; 2]; 4] = [
    [
        [
            [
...
pub(crate) static EOB_BIN_512_Q: [[[u16; 16]; 2]; 4] = [
    [
        [
            32127, 31785, 29061, 27338, 22534, 17810, 13980, 9356, 6707, 0, 0, 0, 0, 0, 0, 0,
        ],
        [
            27673, 26322, 22772, 19414, 16751, 14782, 11849, 6639, 3628, 0, 0, 0, 0, 0, 0, 0,
        ],
    ],
    [
        [
            31538, 30490, 27733, 24992, 20897, 17422, 13178, 8184, 4019, 0, 0, 0, 0, 0, 0, 0,
        ],
        [
            25503, 22789, 16949, 13518, 10988, 8922, 6290, 4372, 957, 0, 0, 0, 0, 0, 0, 0,
        ],
    ],
    [
        [
            30144, 28832, 26288, 23082, 18789, 15042, 9501, 4358, 1690, 0, 0, 0, 0, 0, 0, 0,
        ],
        [
            20753, 17999, 13180, 10716, 8546, 6956, 5468, 3549, 654, 0, 0, 0, 0, 0, 0, 0,
        ],
    ],
    [
        [
...
pub(crate) static EOB_BIN_1024_Q: [[[u16; 16]; 2]; 4] = [
    [
        [
...
pub(crate) static EOB_HI_BIT_Q: [[[[[u16; 2]; 9]; 2]; 5]; 4] = [
    [
        [
            [
                [15807, 0],
...
pub(crate) static EOB_BASE_TOK_Q: [[[[[u16; 4]; 4]; 2]; 5]; 4] = [
    [
        [
            [
                [14931, 3713, 0, 0],
...
pub(crate) static COEFF_BASE_Q: [[[[[u16; 4]; 41]; 2]; 5]; 4] = [
    [
        [
            [
                [28734, 23838, 20041, 0],
...
pub(crate) static COEFF_BR_Q: [[[[[u16; 4]; 21]; 2]; 4]; 4] = [
    [
        [
            [
                [18470, 12050, 8594, 0],
