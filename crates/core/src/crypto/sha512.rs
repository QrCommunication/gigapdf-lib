//! SHA-512 and SHA-384 (FIPS 180-4). Zero dependencies. Needed by the AES-256
...
fn compress(h: &mut [u64; 8], data: &[u8]) {
...
/// SHA-384 digest of `data` (SHA-512 with a different IV, truncated to 48 bytes).
